...
l=['shashank','divum','bangalore']

# explicit execution (via connection)
conn.execute("INSERT INTO emp (name) VALUES (:name)", name="shashank")
conn.execute("INSERT INTO emp (name) VALUES (:name)", name="banglore")
conn.execute("INSERT INTO emp (name) VALUES (:name)", name="internship")
